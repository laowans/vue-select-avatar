...
const selectAvatars = ({
    ...
    if(beforeClose && (beforeClose instanceof Function)) throw new Error('Parameter error: "beforeClose" should be Function')
    ...
    if(!(typeof zoomRatio === 'number' && zoomRatio >= 1)) throw new Error('Parameter error: "zoomRatio" is a number and greater than or equal to 1')
    ...
    if(!(typeof maxKB === 'number' && maxKB >= 1)) throw new Error('Parameter error: "maxKB" is a number and greater than or equal to 1')
    ...
    if(!(typeof minSize === 'number' && minSize >= 0)) throw new Error('Parameter error: "minSize" is a number and greater than or equal to 0')
    if(typeof avatarMaxSize !== 'boolean') throw new Error('Parameter error: "avatarMaxSize" should be boolean')
    if(!(typeof returnAvatarMaxSize === 'number' && returnAvatarMaxSize >= 10)) throw new Error('Parameter error: "returnAvatarMaxSize" is a number and greater than or equal to 10')
            ...
            reader.onload = ()=>{
                ...
                try{
                    ...
                    img.onload = () => {
                        ...
                        if(min < minSize){
                            const err3 = new Error(`Picture resolution is lower than ${minSize}x${minSize}`)
                            err3.code = 2
                            reject(err3)
